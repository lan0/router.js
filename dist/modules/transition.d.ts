...
export default class Transition<T extends Route> implements Partial<Promise<T>> {
    ...
    constructor(router: Router<T>, intent: Maybe<OpaqueIntent>, state: TransitionState<T> | undefined, error?: Maybe<Error>, previousTransition?: Maybe<Transition<T>>);
    /**
    ...
    /**
      ...
      @public
     */
    then<TResult1 = T, TResult2 = never>(onFulfilled?: ((value: T) => TResult1 | PromiseLike<TResult1>) | undefined | null, onRejected?: ((reason: any) => TResult2 | PromiseLike<TResult2>) | undefined | null, label?: string): Promise<TResult1 | TResult2>;
    /**
    ...
    send(ignoreFailure: boolean | undefined, _name: string, err?: Error, transition?: Transition<T>, handler?: Route): void;
    /**
